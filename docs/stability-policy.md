...
- Public classes listed in [public-api.md](/home/ramjf/projects/freeswitch-xml-projection/docs/public-api.md) are intended to remain source-compatible within `v0.1.x` except for bug-fix tightening around invalid input.
